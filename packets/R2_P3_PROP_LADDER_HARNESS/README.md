# R2-P3-KXNFLPASSYDS-PROP-LADDER-HARNESS packet bundle
...
(6 events, `admitted_at` null). All three match the conductor claims.
`FROZEN_EXPERIMENT.json` records those digests and keeps `results` and
`pnl` null.
...
| `panel_stub.json` | Conductor panel stub, 6 events |
...
Panel seed: `lab/astra-capture/r2-p3-prop-slate/panel_stub.json`.
