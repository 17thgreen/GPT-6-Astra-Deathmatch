"""NH-001A collector; see AMENDMENT_A.md. Original collector preserved unchanged."""
...
DECISIONS=['2024-10-29T16:00:00+00:00','2024-11-04T16:00:00+00:00','2024-11-04T22:00:00+00:00','2024-11-05T16:00:00+00:00']
LOCK=threading.Lock()
...
def collect(root, series_file):
    ...
    def candles(job):
        ...
        time.sleep(.3)
        x=get(url,root,'quotes_'+m['ticker']+'_'+d[:10]+'T'+d[11:13])
