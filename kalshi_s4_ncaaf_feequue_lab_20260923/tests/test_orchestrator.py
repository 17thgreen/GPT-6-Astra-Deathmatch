...
class PinTests(unittest.TestCase):
    def test_binding_pins_the_seed_and_the_instruments(self):
        ...
        self.assertEqual(binding['events_n'], 0)
        ...
        self.assertIs(pins['packet_matches_conductor_claim'], False)
        self.assertIs(pins['kernel_matches_conductor_claim'], False)
        self.assertIs(pins['panel_stub_matches_conductor_claim'], False)
        self.assertIs(pins['conductor_bytes_in_checkout'], False)
        self.assertIs(frozen['conductor_bytes_in_checkout'], False)
    ...
    def test_seed_loads_and_admitted_panel_is_preferred_when_present(self):
        ...
        self.assertEqual(panel['cohort_counts']['events_n'], 0)
...
class SchemaTests(unittest.TestCase):
    def test_s4a0_and_s4a1_schema_on_the_empty_seed(self):
        ...
        self.assertEqual(native['event_count'], 0)
        self.assertEqual(fresh['event_count'], 0)
        self.assertEqual(native['cohort_note'], 'conductor_stub_absent_seed_not_invented')
