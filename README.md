...
| `kalshi_kxnhlgame_settled_join_lab_20260923` | NHL-RJ KXNHLGAME settled-resolution join harness. One knob: join_gate. J0 nonempty result required. J1 occurrence datetime match. Scorecard null. Scout N=17 is not settled_join_n. Series settled/finalized/open list 429 left empty. SEP26 parent seeds stay active with an empty result. admit.py not run. Orthogonal to NHL-FQ. 10 unit tests green |
