...
with schema `{meta, samples[]}`. That file is absent on this checkout, so
the lab does not embed a `samples[]` copy. Code verification on
2026-09-23T19:07:28Z: 5 tests, 0 failures. Queue labels cite R1-P5.
