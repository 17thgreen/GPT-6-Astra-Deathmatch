...
from pair_policy import make_engine
...
def one(case):
    ...
    result.update(scenario=name,elapsed_seconds=time.monotonic()-began,evidence='Q7_REUSED_31_GAME_DEVELOPMENT_PAIR_PRICE_HYPOTHETICAL_EXECUTION')
...
def main():
    ...
    labels=['router_off','router_on','allocator_off','allocator_on']
