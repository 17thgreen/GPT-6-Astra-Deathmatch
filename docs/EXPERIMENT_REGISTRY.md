...
| Examiner fee+queue honesty | One Examiner channel on Q6-000. Hypothesis frozen before source. Consumes the hygiene join (`79800a82b8ad2c1e10f614f69fd7105d11e0d041`) and the QF join (`7026be5104cd00cabcf9b34154506a76b2768b8a`). Feebook `22371178cb2663250b4762f328069571c48cb551`. Rails `6a28e0d6254327ea4e6451c781bec56215ac6cac`. Freeze sha256 `4799642e54cf233a925697e00c5a9e29f5cb39070962a2e011f0fbe090c169f2`. `fee_delta_vs_inherited_model`, `freshness_gap_sec`, `queue_bin_mismatch_rate`, `fill_rate_delta_vs_q3300`, `adverse_queue_exposure`, `participation_stress_gap`, `results`, and `pnl` stay null. Not run. Does not replace the Q6 candidate. | `kalshi_examiner_fee_queue_honesty_000_lab_20260922/EXPERIMENT_SPEC.md` |
