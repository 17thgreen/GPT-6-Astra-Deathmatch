...
| Prospective recorder | GET-only schedule-only admission rules, specified before capture. Not deployed. Not a P&L experiment. Separate from Q7. | `nfl_prospective_recorder_20260922/PROTOCOL.md` |
