...
| R2-P1 | Feebook and rails hygiene labels on Q6-000. Fee delta versus the inherited fixed-point model, content-fresh versus keepalive, and queue-bin mismatch against fixed q3300/q10000. Code verification only; pre-settlement outputs null. Does not replace the Q6 candidate. | `kalshi_r2p1_hygiene_000_lab_20260922/results/R2P1_UNIT_RESULTS.md` |
