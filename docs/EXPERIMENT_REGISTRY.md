...
| R1-P5 | Queue, fee-credit, and book-freshness measurement rails. Source frozen before unit results. Not a strategy and not a P&L run. | `kalshi_rails_lab_20260922/EXPERIMENT_SPEC.md` |
