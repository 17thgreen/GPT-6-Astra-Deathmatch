...
from cadence_policy import InventedPnlRefused
...
def execute():
    ...
    if document.get('pnl') is not None or document.get('results') is not None:
        raise InventedPnlRefused('not-run document')
